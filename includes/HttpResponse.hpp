...
class HttpResponse {
	...
	void setResponseByStatus(int statusCode, const ServerBlock *serverBlock = NULL, const std::string &statusMessage="OK", const std::string &bodyContent="", const std::string &contentType="text/html");
